...
6. Provide the output to the saveResultInDatabase tool.
7. Finally call either the optimalFeedback or suboptimalFeedback tool depending on the score.
...
// Ensure that the scoring_breakdown matches the final score, and provide a brief explanation if the confidence is less than 1.
